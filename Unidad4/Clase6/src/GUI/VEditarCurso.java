...
public class VEditarCurso extends JFrame implements ActionListener, MouseListener, KeyListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == bbuscar){
            Curso encontrado = Clase6.mostrarCurso(Integer.parseInt(codigot));
            if(encontrado != null){
            ...
            */
            ...
            //USANDO EL SET
            for (int i = 0; i < Clase6.cursos.size(); i++) {
                if (Clase6.cursos.get(i).getCodigo() == Integer.parseInt(codigot)) {
                    Clase6.cursos.get(i).setNombre(nombret);
                    Clase6.cursos.get(i).setCreditos(Integer.parseInt(creditost));
                }
            }
