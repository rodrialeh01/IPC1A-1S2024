...
public class VEditarCurso extends JFrame implements ActionListener, MouseListener, KeyListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == bbuscar){
            Curso encontrado = Clase8.mostrarCurso(Integer.parseInt(codigot));
            if(encontrado != null){
            ...
            */
            ...
            //USANDO EL SET
            for (int i = 0; i < Clase8.cursos.size(); i++) {
                if (Clase8.cursos.get(i).getCodigo() == Integer.parseInt(codigot)) {
                    Clase8.cursos.get(i).setNombre(nombret);
                    Clase8.cursos.get(i).setCreditos(Integer.parseInt(creditost));
                }
            }
